...
import 'package:loveafghan/util/orientation_popup.dart';
...
class EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    ...
    university = widget.currentUser.editInfo['university'];
    jobCtlr.text = widget.currentUser.editInfo['job_title'];
    setState(() {
      showMe = widget.currentUser.editInfo['userGender'];
      visibleAge = widget.currentUser.editInfo['showMyAge'] ?? true;
      visibleDistance = widget.currentUser.editInfo['DistanceVisible'] ?? true;
      visibleOrientation = widget.currentUser.showOrientation ?? false;
      initialvalue = widget.currentUser.showOrientation ?? false;
    });
    orientation = widget.currentUser.sexualOrientation.cast<String>() ?? [];
    initOrientation = widget.currentUser.sexualOrientation.cast<String>() ?? [];
    super.initState();
  }
  ...
  void dispose() {
    ...
    if (editInfo.length > 0) {
      updateData();
    } else if (visibleOrientation != initialvalue) {
      updateOrientation();
    } else if (initOrientation != orientation) {
      updateOrientation();
    }
  }
  ...
  Future updateData() async {
    Firestore.instance
      ...
      'sexualOrientation': {
        ...
        "showOnProfile": visibleOrientation
      }
    }, merge: true);
  }
                      ...
                      Padding(
                        ...
                        child: Center(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              getTranslated(
                                  context, 'cant_upload_more_than_9_pictures'),
                              style: TextStyle(
                                  fontSize: 15,
                                  color: Colors.black,
                                  decoration: TextDecoration.none),
        ...
        try {
          if (isProfilePicture) {
            ...
            currentUser.imageUrl
                .insert(0, Photo(url: fileURL, approved: "false"));
            print("object: ${currentUser.imageUrl}");
            await Firestore.instance
                .collection("Users")
                .document(currentUser.id)
                .setData({
              "Pictures": (currentUser.imageUrl)
                  .map((e) => {"url": e.url, "approved": e.approved}
                      .cast<String, dynamic>())
                  .toList(),
            }, merge: true);
            print("Done!!!!!!! Changed!!!!!!!!!");
            ...
            widget.currentUser.imageUrl
                .add(Photo(url: fileURL, approved: "false"));
          }
          if (mounted) setState(() {});
        } catch (err) {
          print("Error: $err");
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          leading: IconButton(
            ...
            color: primaryColor,
            onPressed: () =>
                Navigator.of(context).pop(editInfo.length > 0 ? true : false),
          ),
          backgroundColor: Colors.white),
      body: Scaffold(
        backgroundColor: Colors.white,
                        ...
                        children: <Widget>[
                          ListTile(
                            ...
                            subtitle: CupertinoTextField(
                              ...
                              maxLines: 10,
                              minLines: 3,
                              placeholder: getTranslated(context, 'about_you'),
                              padding: EdgeInsets.all(10),
                              onChanged: (text) {
                          ...
                          ListTile(
                            title: Text(
                              getTranslated(context, 'job_title'),
                              style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 16,
                                  color: Colors.black87),
                            ...
                            subtitle: CupertinoTextField(
                              ...
                              cursorColor: primaryColor,
                              placeholder:
                                  getTranslated(context, 'add_job_title'),
                              padding: EdgeInsets.all(10),
                              onChanged: (text) {
                          ...
                          ListTile(
                            ...
                            subtitle: CupertinoTextField(
                              ...
                              cursorColor: primaryColor,
                              placeholder:
                                  getTranslated(context, 'add_company'),
                              padding: EdgeInsets.all(10),
                              onChanged: (text) {
                          ...
                          ListTile(
                            ...
                            subtitle: DropdownButton(
                              ...
                              onChanged: (String newValue) {
                                setState(() {
                                  university = newValue;
                                  editInfo.addAll({'university': university});
                                });
                              },
                              isExpanded: true,
                          ...
                          ListTile(
                            ...
                            title: Text("My Orientation"),
                            subtitle: Text(orientation
                                .toString()
                                .replaceAll('[', '')
                                .replaceAll(']', '')),
                            trailing: Icon(
                          ...
                          ListTile(
                            title: Text(
                              getTranslated(context, 'living_in'),
                              style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 16,
                                  color: Colors.black87),
                            ...
                            subtitle: CupertinoTextField(
                              ...
                              cursorColor: primaryColor,
                              placeholder: getTranslated(context, 'add_city'),
                              padding: EdgeInsets.all(10),
                              onChanged: (text) {
                            ...
                            child: ListTile(
                              ...
                              subtitle: DropdownButton(
                                ...
                                items: [
                                  ...
                                  DropdownMenuItem(
                                      child:
                                          Text(getTranslated(context, 'other')),
                                      value: "other"),
                                ],
                                onChanged: (val) {
                          ...
                          ListTile(
                              title: Text(
                                getTranslated(context, 'control_your_profile'),
                                style: TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 16,
                                    color: Colors.black87),
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text(
                                              "Show My Orientation"), // TODO: translate
                                        ),
                                        Switch(
                                            activeColor: primaryColor,
