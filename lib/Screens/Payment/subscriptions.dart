    ...
    if (widget.isPaymentSuccess != null && !widget.isPaymentSuccess) {
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        await Alert(
          ...
          desc: getTranslated(context, 'oops_somthing_went_wrong_try_again'),
          buttons: [
            DialogButton(
              child: Text(
          ...
          _scaffoldKey.currentState.showSnackBar(
            SnackBar(
              content: error != null
                  ? Text('$error')
                  : Text(getTranslated(
                      context, 'oops_somthing_went_wrong_try_again')),
            ),
          );
        },
      );
    ...
    List adds = [
      {
        'icon': Icons.whatshot,
        'color': Colors.indigo,
        'title': "Unlimited Swipes", // TODO: translate this
        'subtitle': "See more profiles", // TODO: translate this
      },
      {
        'icon': Icons.favorite,
        'color': Colors.lightBlueAccent,
        'title': "Call your Matches", // TODO: translate this
        'subtitle': "30 Minutes Every Month", // TODO: translate this
      },
      {
        'icon': Icons.star_half,
        'color': Colors.amber,
        'title': "Video Call Your Match", // TODO: translate this
        'subtitle': "10 Minutes Every Month", // TODO: translate this
      },
      {
        'icon': Icons.location_on,
        'color': Colors.purple,
        'title': "Swipe around the world", // TODO: translate this
        'subtitle':
            "See more profiles around the world!", // TODO: translate this
      },
      {
        'icon': Icons.vpn_key,
        'color': Colors.orange,
        'title': "Add On More minutes!", // TODO: translate this
        'subtitle':
            "More calling Minutes with your match!", // TODO: translate this
      }
    ];
    return Scaffold(
      key: _scaffoldKey,
                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      dense: true,
                      title: Text(
                        getTranslated(context, 'get_our_premium_plans'),
                    ...
                    ListTile(
                      ...
                      title: Text(
                        getTranslated(context, 'unlimited_swipes'),
                        style: TextStyle(
                    ...
                    ListTile(
                      ...
                      title: Text(
                        getTranslated(context, 'search_users_around'),
                        style: TextStyle(
                            ...
                            : Container(
                                ...
                                child: Center(
                                  child: Text(getTranslated(
                                      context, 'no_active_product_found')),
                                ),
                              )
                  ],
                ),
                      ...
                      if (selectedProduct != null)
                        ...
                        CustomSnackbar.snackbar(
                            getTranslated(context,
                                'you_must_choose_a_subscription_to_continue'),
                            _scaffoldKey);
                      }
                    },
                  ),
                            ...
                            builder: (ctx) {
                              return AlertDialog(
                                content: Text(getTranslated(
                                    context, 'no_purchase_found')),
                                title: Text(
                                    getTranslated(context, 'past_purchase')),
                              );
                            });
                      }
                    },
