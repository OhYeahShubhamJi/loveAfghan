...
import 'package:loveafghan/Screens/auth/otp_verification.dart';
...
class _OTPState extends State<OTP> {
                  ...
                  child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Text(
                            getTranslated(context, 'verified_successfully'),
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                decoration: TextDecoration.none,
                                color: Colors.black,
              ...
              child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        getTranslated(context, 'verification_code_sent'),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            decoration: TextDecoration.none,
                            color: Colors.black,
  ...
  _verificationFailed(AuthException authException, BuildContext context) {
    CustomSnackbar.snackbar("" + authException.message, _scaffoldKey);
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ListTile(
                title: Text(
                  getTranslated(context, 'verify_your_number'),
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 27, fontWeight: FontWeight.bold),
                ),
                subtitle: Text(
                  getTranslated(context, 'please_enter_your_mobile_number'),
                  textAlign: TextAlign.center,
                      ...
                      title: Container(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText:
                                getTranslated(context, 'enter_your_number'),
