import 'dart:io';
import 'package:apple_sign_in/apple_sign_in.dart' as appleImport;
...
import 'package:loveafghan/models/custom_web_view.dart';
import 'package:loveafghan/util/color.dart';
import 'package:url_launcher/url_launcher.dart';

class Login extends StatelessWidget {
  static const your_client_id =
      '327939821867896'; //repalce 000000000000 with your fb Id
  final FirebaseAuth _auth = FirebaseAuth.instance;
  static const your_redirect_url =
      'https://loveafghan-de2aa.firebaseapp.com/__/auth/handler'; //replace with your auth handler url from firebase
            ...
            children: <Widget>[
              ...
              Column(children: <Widget>[
                ...
                Container(
                  child: Text(
                    getTranslated(
                        context, 'by_tapping_login_you_agree_to_privacy'),
                ...
                Platform.isIOS
                    ? Padding(
                        ...
                        child: appleImport.AppleSignInButton(
                          style: appleImport.ButtonStyle.black,
                          cornerRadius: 50,
                          type: appleImport.ButtonType.defaultButton,
                          onPressed: () async {
              ...
              Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: () => launch("https://loveafghan.com/privacy.html"),
                  ),
                  Container(
                  ...
                  GestureDetector(
                    ...
                    onTap: () => launch("https://loveafghan.com/terms.html"),
                  ),
                ],
              )
            ],
        ...
        return showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content:
                  Text(getTranslated(context, 'do_you_want_to_exit_the_app')),
              actions: <Widget>[
                FlatButton(
  ...
  Future<FirebaseUser> handleAppleLogin() async {
    FirebaseUser user;
    if (await appleImport.AppleSignIn.isAvailable()) {
      try {
        final appleImport.AuthorizationResult result =
            await appleImport.AppleSignIn.performRequests([
          appleImport.AppleIdRequest(requestedScopes: [
            appleImport.Scope.email,
            appleImport.Scope.fullName
          ])
        ]).catchError((onError) {
        ...
        switch (result.status) {
          case appleImport.AuthorizationStatus.authorized:
            try {
              print("successfull sign in");
              final appleImport.AppleIdCredential appleIdCredential =
                  result.credential;
            ...
            break;
          case appleImport.AuthorizationStatus.error:
            // do something
          ...
          case appleImport.AuthorizationStatus.cancelled:
  ...
  await Firestore.instance.collection("Users").document(user.uid).setData(
    {
      ...
      'UserName': user.displayName != null
          ? user.displayName.split(" ").sublist(0, 1).join(" ")
          : '',
