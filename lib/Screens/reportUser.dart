    ...
    return CupertinoAlertDialog(
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                getTranslated(context, 'report_user'),
            ...
            Text(
              getTranslated(context,
                  'is_this_person_bothering_you_tell_us_what_they_did'),
              textAlign: TextAlign.center,
      ...
      actions: !other
          ? <Widget>[
              Material(
                child: ListTile(
                    title: Text(getTranslated(context, 'inappropriate_photos')),
                    leading: Icon(
                      Icons.camera_alt,
                      color: Colors.indigo,
                    ),
              ...
              Material(
                child: ListTile(
                    title: Text(
                      getTranslated(context, 'feels_like_spam'),
                    ),
                    leading: Icon(
              ...
              Material(
                child: ListTile(
                    title: Text(
                      getTranslated(context, 'user_is_underage'),
                    ),
                    leading: Icon(
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: getTranslated(
                              context, 'additional_info_optional')),
                    ),
                    Padding(
              ...
              child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text(
                        getTranslated(context, 'reported'),
                        textAlign: TextAlign.center,
                        style: TextStyle(
